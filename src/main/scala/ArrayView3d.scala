...
trait ArrayView3d[T] extends ArrayViewNd[T, ArrayView3d[T]]:
  ...
  def fill(f: (i0: Int, i1: Int, i2: Int) => T): Unit =
    foreachIndex { (i0, i1, i2) =>
  ...
  [T1 <: Int | Range,
    ...
    val offset = getPos(start0, start1, start2)
